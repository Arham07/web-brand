// Legal copy, kept as markdown so it stays diffable and editable by a
// non-developer. Rendered by components/legal/LegalDoc.tsx — see that file
// for which markdown constructs are supported (h2, paragraph, bullet, bold,
// horizontal rule). Do not add tables or links without extending it.

export const PRIVACY_POLICY = `Last updated: 19 August 2026

American Web Guild ("we," "us," or "our") operates americanwebguild.com (the "Site") and provides web design, development, branding and visual production services (the "Services"). This policy explains what we collect, why, and what you can do about it.

By using the Site or contacting us, you agree to this policy.
...
For any privacy question or request, email us at the address above with "Privacy" in the subject line.

---

## 2. Information we collect

**Information you give us directly.** When you submit a form, email us, message us on social media, book a call, or become a client, we may collect:
...
- Website URL
- Project details, budget range, and anything else you choose to tell us
- Billing and payment information (processed by our payment providers — see Section 6)
- Files, images, copy, logins, and other materials you send us for a project

**Information collected automatically.** When you visit the Site, we and our analytics and advertising providers may automatically collect:
...
**Information from third parties.** If you interact with our ads or pages on Meta (Facebook and Instagram), Google, LinkedIn or similar platforms, those platforms may share limited information with us, such as the fact that you clicked an ad, submitted a lead form, or sent a message.

**We do not knowingly collect information from anyone under 16.** If you believe a child has given us information, contact us and we will delete it.
...
- Respond to enquiries and provide quotes, concepts and proposals
- Deliver, manage and support our Services
- Send project updates, invoices and account communications
- Process payments and keep financial records
- Operate, secure, debug and improve the Site
- Measure and improve our marketing, including advertising on Meta and other platforms
- Send marketing emails, where you have opted in or are an existing client (you can unsubscribe at any time)
...
## 4. Legal bases for processing (UK/EU visitors)
...
- **Legitimate interests** — to run and improve our business, secure the Site, and market to businesses in a proportionate way
- **Consent** — for non-essential cookies, advertising and analytics, and for marketing emails where consent is required
...
- **Essential cookies** keep the Site working — page delivery, security, and form submission. These cannot be switched off.
- **Analytics cookies** tell us how the Site is used so we can improve it (for example, Google Analytics).
- **Advertising cookies and pixels** measure and target advertising. This includes the **Meta Pixel** and, where enabled, the Meta Conversions API, Google Ads tags, and similar tools. These allow us to see which ads lead to enquiries and to show ads to people who have visited the Site.

You can control cookies through your browser settings and, where we display one, through our cookie banner. Blocking non-essential cookies will not stop you using the Site. To opt out of interest-based advertising more broadly, see the tools at youradchoices.com, optout.networkadvertising.org, and your Meta and Google ad settings.

**Do Not Track.** Browsers send inconsistent Do Not Track signals and there is no agreed standard, so we do not currently respond to them.

---

## 6. Who we share information with

We share information only where necessary, and only with:

- **Service providers** who work on our behalf — hosting and infrastructure, email and CRM, analytics, payment processing, scheduling, file storage, and project management tools. They may only use the data to provide services to us.
- **Advertising and analytics platforms** — including Meta, Google and similar, in the ways described in Section 5.
- **Professional advisers** — accountants, lawyers and insurers, where required.
- **Authorities** — where we are legally required to disclose, or to protect our rights, safety or property.
- **A buyer or successor** — if we are involved in a merger, acquisition, financing or sale of assets.
...
Our providers may store or process data in countries other than yours, including the United States. Where personal data is transferred out of the UK or EEA, we rely on appropriate safeguards such as Standard Contractual Clauses or an adequacy decision.
...
- **Client project records and correspondence** — for the duration of the engagement and up to 7 years afterwards, for legal, tax and warranty purposes
- **Financial and invoicing records** — as required by tax law in our jurisdiction
- **Analytics and advertising data** — per the retention settings of the relevant platform
- **Marketing contacts** — until you unsubscribe or ask us to delete you

---

## 9. Security

We use reasonable technical and organisational measures to protect your information, including encrypted connections (HTTPS), access controls, and vetted third-party providers. No system is completely secure, and we cannot guarantee absolute security. If you send us credentials or sensitive project material, use a secure method and tell us when they can be revoked.
...
**California residents** additionally have the right to know the categories of personal information collected, the purposes for collection, and the categories of third parties it is shared with, and the right to opt out of "sharing" for cross-context behavioural advertising. We do not sell personal information as defined by the CCPA/CPRA.

To exercise any right, email info@americanwebguild.com. We will respond within the time required by applicable law (generally 30 days). We may need to verify your identity first.

If you are in the UK or EU and are unhappy with our response, you may complain to your local data protection authority.

---

## 11. Third-party links

The Site links to other websites and platforms we do not control. This policy does not apply to them. Check their privacy policies before giving them information.

---

## 12. Client project data

When we build or maintain a website for you, we may have access to your systems, content, analytics and customer data. We treat that data as confidential, use it only to deliver the Services, and do not use it for any other purpose. Where we process personal data on your behalf, we act as a processor and you act as the controller, and we will enter a data processing agreement on request.

---

## 13. Changes to this policy

We may update this policy from time to time. The "Last updated" date at the top shows the most recent version. Material changes will be announced on this page.
...
export const TERMS = `Last updated: 19 August 2026
